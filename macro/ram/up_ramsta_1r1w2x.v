...
// Created On   : Sat May 27 14:58:38 2017
// History (Date, Changed By)
//
////////////////////////////////////////////////////////////////////////////////

module up_ramsta_1r1w2x
    (
     clk,
     rst_n,
...
generate
    ...
    if ((G_FAMILY == "XILINX") & (G_TYPE == "BLOCK")) // Because only Xilinx's Block Ram already anti-conflict at stage 0
        ...
        assign          ram_rdat    = (anti_stage1 ? ram_wdat1 : imemdo); // Reduced 1 stage logic here
        end
    else
        begin
        ...
        s_dff_nclk #(2) ppl_anti_stage0(clk, rst_n, (wr_conflict & ram_re), anti_stage0);

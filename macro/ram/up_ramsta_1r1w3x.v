...
//  + Read& write done after 3 clock cycle
...
// Created On   : Sat May 27 14:58:13 2017
// History (Date, Changed By)
//
////////////////////////////////////////////////////////////////////////////////

module up_ramsta_1r1w3x
    (
     clk,
     rst_n,
...
wire [G_WIDTH-1:0]      ram_wdat1, ram_wdat2;
...
wire                    anti_stage1;
s_dff #(0)              pl_anti_stage1 (clk, rst_n, cur_anti_stage1, anti_stage1);  // clk 3


wire                    nxt_anti_stage2, cur_anti_stage2;
assign                  nxt_anti_stage2 = ram_we & ram_re2 & (ram_wa == ram_ra2);    // clk 2
s_dff #(0)              reg_anti_stage2(clk, rst_n, nxt_anti_stage2, cur_anti_stage2);  // clk 3

wire                    anti_stage2;
assign                  anti_stage2 = cur_anti_stage2; // clk 3
...
generate
    ...
    if ((G_FAMILY == "XILINX") & (G_TYPE == "BLOCK")) // Because only Xilinx's Block Ram already anti-conflict at stage 0
        ...
        assign          ram_rdat    = (anti_stage2 ? ram_wdat1 : 
                                       anti_stage1 ? ram_wdat2 : imemdo); // Reduced 1 stage logic here
        end
    else
        begin
        ...
        s_dff_nclk #(3) ppl_anti_stage0(clk, rst_n, (wr_conflict & ram_re), anti_stage0);

        wire [G_WIDTH-1:0]      ram_wdat3;
        s_pl_reg #(G_WIDTH)     pl_ram_wdat2(clk, rst_n, ram_wdat2, ram_wdat3);
        
        assign          ram_rdat    = (anti_stage2 ? ram_wdat1 :
                                       anti_stage1 ? ram_wdat2 :
                                       anti_stage0 ? ram_wdat3 : imemdo);
        end
    end
endgenerate
